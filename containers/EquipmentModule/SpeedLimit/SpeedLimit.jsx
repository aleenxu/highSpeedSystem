...
class SpeedLimit extends React.Component {
  ...
  componentDidMount = () => {
    ...
    /* this.handlelistDetail('deviceSizeList', 26) */
    // 获取级联方向下拉
  ...
  handleListupdate = () => {
    ...
    const { port, deviceId, deviceName, vendor, roadName, pileNum, direction, roadSecId, deviceIp } = this.board
    if (deviceId == '') {
      message.warning('请填写设备编号')
      return
    }
                  ...
                  <div className={styles.ItemLine}>
                    ...
                    <div className={styles.Item}>
                      <Form.Item
                        ...
                        rules={[{ required: true, message: 'Please select your country!' }]}
                      >
                        <Select disabled onChange={(e) => { this.handleSelect(e, 'deviceTypeId', 'board') }} defaultValue={3}> 
                          {
                    ...
                    {/* <div className={styles.Item}>
                      <Form.Item
                        ...
                        rules={[{ required: true, message: 'Please select your country!' }]}
                      >
                        <Select onChange={(e) => { this.handleSelect(e, 'deviceSize', 'board') }} defaultValue={boardData.deviceSize}>
                          {
